...
def train(args):
    ...
    {'params': model.camencode.backbone.parameters(), 'lr': args.lr * 0.1},
...
if __name__ == '__main__':
    ...
    parser.add_argument("--backbone", type=str, default='yolov8s', choices=['yolov8n', 'yolov8s', 'yolov8m'], help='YOLOv8 backbone size')
    parser.add_argument("--backbone_lr_factor", type=float, default=0.1, help='Learning rate factor for backbone')
